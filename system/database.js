module.exports = (m) => {
   ...
   if (setting) {
      ...
      if (!('sk_pack' in setting)) setting.sk_pack = 'Siesta - Multi Device'
      if (!('sk_author' in setting)) setting.sk_author = '@Swift Developer'
      ...
      if (!('owners' in setting)) setting.owners = ['6288980870067', '6288980870067']
      ...
      global.db.setting = {
         ...
         online: true,
         onlyprefix: '+',
         owners: ['6288980870067', '6288980870067'],
